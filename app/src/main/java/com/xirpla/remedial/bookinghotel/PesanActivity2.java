...
public class PesanActivity2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtAlamat = findViewById(R.id.txtAlamat2);
        txtNamaHotel = findViewById(R.id.txtNamaHotel2);
        txtAlamatHotel = findViewById(R.id.txtAlamatHotel2);
        txtCI = findViewById(R.id.txtCI2);
        txtCO = findViewById(R.id.txtCO2);
        txtHarga = findViewById(R.id.txtHarga2);
        btnChi = findViewById(R.id.btnChi2);
        btnCho = findViewById(R.id.btnCho2);
        txtJamCI = findViewById(R.id.txtJamCI2);
        txtJamCO = findViewById(R.id.txtJamCO2);
        txtJmlTamu = findViewById(R.id.txtJmlTamu2);
        txtLmMeng = findViewById(R.id.txtLmMeng2);
        spPembayaran2 = findViewById(R.id.spinner2);
        ...
        spPembayaran2.setAdapter(pembayaran);
        ...
        btnHitung.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                int tanggalCI = Integer.parseInt(txtLmMeng.getText().toString());
                int tanggalCO = Integer.parseInt(txtJmlTamu.getText().toString());
                int totalHarga = (tanggalCO * tanggalCI)*351000;
                txtHarga.setText(totalHarga+"");
            }
        });

        btnPesan1 = findViewById(R.id.btnPesan12);
    ...
    private void Pesan() {
        ...
        txtpem = spPembayaran2.getSelectedItem().toString().trim();
        StringRequest stringRequest = new StringRequest(StringRequest.Method.POST, URL,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try{
                            ...
                            if(success.equals("1")){
                                Toast.makeText(PesanActivity2.this, "Pesan Berhasil!", Toast.LENGTH_SHORT).show();
                                Intent pindah_login = new Intent(PesanActivity2.this, BelumBayarActivity.class);
                                startActivity(pindah_login);
                            }
                        }catch(JSONException e){
                            e.printStackTrace();
                            Toast.makeText(PesanActivity2.this, "Pesan Error : " +e.toString(), Toast.LENGTH_SHORT).show();
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(PesanActivity2.this, "Pesan Error : " +error.toString(), Toast.LENGTH_SHORT).show();
                }
        })
        {
            @Override
