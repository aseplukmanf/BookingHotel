...
public class AdapterList extends RecyclerView.Adapter<AdapterList.ViewHolder>{
    ...
    public AdapterList(ListVoucherActivity listVoucherActivity, ArrayList<HashMap<String, String>> list_data) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_list_voucher, null);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(ViewHolder holder, int position) {
        holder.txtIdTransaksi.setText(list_data.get(position).get("id_transaksi"));
        holder.txtNamaPemesan.setText(list_data.get(position).get("nama_lengkap"));
        holder.txtNamaHotel.setText(list_data.get(position).get("nama_hotel"));
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View itemView) {
            ...
            btnDetil = (Button) itemView.findViewById(R.id.btnDetil);
